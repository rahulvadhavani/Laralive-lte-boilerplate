    ...
    <div class="modal-content card" wire:ignore.self class="modal fade">
      ...
      <div class="card-body">
        ...
        <div class="modal-footer card-header">
          ...
          <button type="submit" wire:click.prevent="submit" wire:loading.attr="disabled" wire:target="submit" class="btn btn-primary">@if($recordId == 0) Submit @else Update @endif <span wire:target="submit"  wire:loading wire:target="submit"><i class="fa-solid fa-circle-notch fa-spin"></i></span></button>
        </div>
      </div>
    </div>
  </div>
